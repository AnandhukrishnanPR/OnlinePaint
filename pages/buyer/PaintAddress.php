...
//if($pohead_id)
//{
//    $sels="select * from tbl_paint_color where pohead_id='".$pohead_id."'";
...
if(isset($_POST['btnsave']))
{
    ...
    $ins2 = "update tbl_paint_order_head set oaddress_id='" . $datah['oaddress_id'] . "',pohead_status='waiting...' where pohead_id='".$pohead_id."'";
...
{
    $adid=$_POST['txtoadd'];
    $ins2 = "update tbl_paint_order_head set oaddress_id='" . $adid . "',pohead_status='waiting...' where pohead_id='".$pohead_id."'";
    mysqli_query($con, $ins2);
    echo "<script>
    alert('Order Sended successfully');
    window.location.href='PaintOrderStatus.php';
