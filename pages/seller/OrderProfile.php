                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                        <form method="post" class="form-sample">
                            <div class="col-md-12">
                                <div class="form-group row">
                                    <button type="submit" name="btnaccept" class="btn btn-success"> ACCEPT ORDER </button>
                                    &nbsp;&nbsp;<button type="submit" name="btnreject" class="btn btn-danger"> REJECT ORDER </button>
                                    &nbsp;&nbsp;<a href="ViewOrders.php" class="btn btn-gradient-light"> BACK </a>
                                </div>
                            </div>
                        </form>
                    </div>
