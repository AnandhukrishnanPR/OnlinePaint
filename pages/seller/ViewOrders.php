                  ...
                  <div class="card-body">
                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                          <?php
                          $i=1;
                          $sel="select * from tbl_paint_order_head where pohead_status<>'active' and seller_id='".$_SESSION['UserID']."'";
                        ...
                        <tr>
                          ...
                          {
                          ?>
                          <td><label class="badge badge-gradient-warning"> waiting... </label></td>
                          ...
                          <td class="text-success"><a href="AcceptedOrders.php?pohead_id=<?php echo $data['pohead_id'];?>"> View More </a></td>
                          <?php   
                          ...
                          {
                          ?>
                          <td><label class="badge badge-gradient-info"> Cancelled </label></td>
                          <td>---</td>
                          <?php
                          }
                          ?>
